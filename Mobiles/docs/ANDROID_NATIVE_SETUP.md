...
empty, and the app appears in Frontend Observability. Native mobile OTLP ingestion
must be enabled on your stack; use the app-specific endpoint from its setup page.
